...
const AllServices = () => {
    return (
        <div>
            <div className="collapse bg-base-200 border-base-300 px-8 sm:px-6 md:px-10 mt-10 rounded-3xl py-4 mx-auto">
                <input id="my-accordion-1" type="checkbox" className="hidden" />
                <label htmlFor="my-accordion-1">
                    <div className="font-semibold">
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-10 justify-between">
                            ...
                            {/* Learn More Button */}
                            <div className="font-bold text-2xl sm:text-3xl md:text-4xl flex md:gap-3 gap-2 cursor-pointer hover:text-primary transition-colors pb-2">
                                Learn More
                                <p className="mt-[6px] md:mt-[7px]">
                                    <FaArrowRight className="bg-black md:p-2 rounded-full text-primary" />
                                </p>
                            </div>
                        </div>
                    </div>
